    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                según que boton se pulde */
                    ...
                    if(nivel.equalsIgnoreCase("4")){
                        switch (contador){
                            ...
                            case 10:
                                if(rbTres.isChecked()){
                                    Toast.makeText(Juego4Activity.this, "CORRECTA", Toast.LENGTH_SHORT).show();
                                    puntos++;
                                    gestionDatos();
                                }else{
                                    Toast.makeText(Juego4Activity.this, "INCORRECTA", Toast.LENGTH_SHORT).show();
                                    vidas--;
                                    gestionDatos();
                                }
                                break;
        ...
        private void obtenetDatosUsuario(){
            ...
            miBD.child((String) getResources().getText(R.string.usuarios)).child(id).addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(Juego4Activity.this, "No se ha podido acceder a los datos", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        private void gestionDatos(){
            ...
            if(vidas == 0){
                ...
                Toast.makeText(Juego4Activity.this, "HAS PERDIDO, INTENTALO OTRA VEZ", Toast.LENGTH_SHORT).show();
                ...
                handler.postDelayed(new Runnable() {
                    public void run() {
                        ...
                        startActivity(new Intent(Juego4Activity.this, MenuActivity.class));
                        finish();
                    }
                }, 1000);

            }
            if(nivel.equalsIgnoreCase("4") && puntos == 127){
                contador = -1;
                salto = 5;
                nuevoNivel++;
                actualizarDatosUsuario(puntos, vidas, nuevoNivel);
                Toast.makeText(Juego4Activity.this, "PASAS DE NIVEL, ENHORABUENA!!!", Toast.LENGTH_SHORT).show();
